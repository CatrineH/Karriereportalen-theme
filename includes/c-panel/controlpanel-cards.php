<div class="container-panel">
    ...
    <!-- Third Card -->
    <div class="custom-card">
        <div class="custom-card" onclick="location.href='faq';" style="cursor: pointer;">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/animations/Woman-speaking-into-megaphone.gif" alt="Woman speaking into megaphone">
            <div class="custom-card-body text-center">
                <h5 class="card-title">FAQ</h5>
                <p class="card-text">Sitter du fast? Sjekk våre ofte stilte spørsmål for hjelp.</p>
            </div>
        </div>
    </div>
</div>
