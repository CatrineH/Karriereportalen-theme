<form class="form text-center" action="<?php echo wp_login_url(); ?>" method="post">
   ...
   <h4>Du vil finne annonsen under <span class="red-text" style="color: #9E182F;"><span class="red-text" style="color: #9E182F;"><a href="/user-ad-list-page" style="color: #9E182F;">mine annonser</span> når den er klar.</h4></h2>
   <br>
